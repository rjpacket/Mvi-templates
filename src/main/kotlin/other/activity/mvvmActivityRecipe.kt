...
import other.activity.src.app_package.mvvmAcitivityKt
import other.activity.src.app_package.mvvmRepository
...
//    )
    ...
    // 保存Activity
    save(mvvmActivity, srcOut.resolve("${activityClass}/${activityClass}Activity.${ktOrJavaExt}"))
    // 保存xml
